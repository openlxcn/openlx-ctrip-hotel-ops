...
import {hash} from '../skills/openlx-ctrip-hotel-ops/scripts/core.mjs';
import {assertEnrollmentBinding,leaseController} from '../skills/openlx-ctrip-hotel-ops/scripts/licensing.mjs';
const payload={hotel_id:'hotel-a',device_id:'device-a',user_id:'user-a',refresh_origin:'https://ctrip.openlx.cn',device_token_hash:hash('token-a')};
